...
//        progressDialog = new SpotsDialog(OrderInfo.this, R.style.Custom);
//        progressDialog.show();
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.GET, HI1, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    itemAdapter = new ItemAdapter(OrderInfo.this, list);
...
//                mShimmerViewContainer.setVisibility(View.GONE);
    ...
    public void submitForm()
    {
        ...
        RequestQueue queue = Volley.newRequestQueue(OrderInfo.this);
